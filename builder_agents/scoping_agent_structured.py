...
2. Identify what fields are still missing
3. Provide a helpful response guiding the user to the next missing field
4. If all fields are complete, provide the completion message
...
Be helpful and guide the user through the scoping process step by step."""
    ...
    def handle(self, state: Dict[str, Any], message: Message) -> Dict[str, Any]:
        ...
        try:
            ...
            print(f"Error in structured scoping agent: {e}")
